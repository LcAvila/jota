        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#produtos" className="text-gray-300 hover:text-green-400 transition-colors flex items-center gap-2">
                  <span>🍺</span> Nossos Produtos
                </a>
              </li>
              <li>
                <a href="#combos" className="text-gray-300 hover:text-green-400 transition-colors flex items-center gap-2">
                  <span>🎉</span> Combos Promocionais
                </a>
              </li>
              <li>
                <a href="#sobre" className="text-gray-300 hover:text-green-400 transition-colors flex items-center gap-2">
                  <span>🏢</span> Sobre Nós
                </a>
              </li>
              <li>
                <a href="#contato" className="text-gray-300 hover:text-green-400 transition-colors flex items-center gap-2">
                  <span>📞</span> Contato
                </a>
              </li>
            </ul>
